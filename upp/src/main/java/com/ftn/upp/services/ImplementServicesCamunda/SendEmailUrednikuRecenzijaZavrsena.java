...
@Service
public class SendEmailUrednikuRecenzijaZavrsena implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        mail.setSubject("Rad pregledan");

        mail.setText("Recenzija rada je zavrsena!");
        //       javaMailSender.send(mailRedactor);

        System.out.println("Email Rad pregledan!");
    }
}
